            ...
            <Card className={cn('w-full max-w-md')}>
                ...
                >
                    ...
                    <div className={'flex flex-col'}>
                        ...
                        <Text variant="default" className={cn('mt-2 text-destructive')} text="Insufficient rights" />
                    </div>
                </div>
                <CardFooter className="flex flex-col items-center space-y-4">
                    <p className={cn('text-center text-sm text-muted-foreground')}>
                        Please contact the site administrator to obtain access rights to this page. You will be
                        redirected to dashboard in {countdown} seconds.
                    </p>
                    <Anchor href="/dashboard" text={'Go to Dashboard Page'} />
                </CardFooter>
            </Card>
        </div>
    )
