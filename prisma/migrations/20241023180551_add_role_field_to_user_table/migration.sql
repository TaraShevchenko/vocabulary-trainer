...
CREATE TABLE "Taggable" (
    ...
    CONSTRAINT "Taggable_pkey" PRIMARY KEY ("tagId","wordId")
);
...
CREATE TABLE "Categorable" (
    ...
    CONSTRAINT "Categorable_pkey" PRIMARY KEY ("wordId","categoryId")
);
...
-- CreateIndex
CREATE UNIQUE INDEX "WordRelation_wordId_relatedWordId_key" ON "WordRelation"("wordId", "relatedWordId");
...
-- AddForeignKey
ALTER TABLE "Taggable" ADD CONSTRAINT "Taggable_wordId_fkey" FOREIGN KEY ("wordId") REFERENCES "Word"("id") ON DELETE RESTRICT ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "Categorable" ADD CONSTRAINT "Categorable_wordId_fkey" FOREIGN KEY ("wordId") REFERENCES "Word"("id") ON DELETE RESTRICT ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "Categorable" ADD CONSTRAINT "Categorable_categoryId_fkey" FOREIGN KEY ("categoryId") REFERENCES "Category"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
